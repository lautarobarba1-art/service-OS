...
export default async function CustomersPage() {
  ...
  const customers = await withAuthenticatedRls(user.id, (transaction) =>
    transaction.customer.findMany({ where: { organizationId: activeMembership.organizationId }, orderBy: { createdAt: "desc" } }),
  );
